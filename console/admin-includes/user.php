...
<h1>CUSTOMER</h1>
	...
	<form id="form" class="form-horizontal" method="post" action="">
						...
						<div class="panel-body">
								...
								<div class="form-group">
									<div class="col-md-6 col-md-offset-4">
										<h1>ORDER HISTORY ( <?= $row->email; ?> )</h1>
									</div>
								</div>								
								
								
								<?php foreach($orderObj->getAllByEmailAddress(trim($row->email)) as $order){ ?>
								
								<div class="form-group">
									<div class="col-md-6 col-md-offset-4">
										<a target="_blank" style="color:#000" href="account?page=order&id=<?= $order->order_id ?>"><?= date('d/m/Y', strtotime($order->order_date)) ?> - Order: <?= $order->order_number ?></a><br />
									</div>
								</div>
